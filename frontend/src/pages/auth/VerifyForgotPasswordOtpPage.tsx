...
import { useVerifyForgotPasswordOtp } from "../../lib/hooks/useAuth";
...
export function VerifyForgotPasswordOtpPage() {
  ...
  // No forgot-password request in progress — nothing to verify.
  if (!pendingAuth || pendingAuth.purpose !== "forgot-password") {
      ...
      panel={
        <div className="w-full">
          <FeatureCard
            ...
            title="Almost there"
            description="Confirm the code to set a new password"
            delay={0.1}
          />
        </div>
      }
